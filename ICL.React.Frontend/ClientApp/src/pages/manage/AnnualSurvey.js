    ...
    <React.Fragment>
      <Grid container p={isLgUp ? 12 : 5}>
        <Grid item md={12}>
          ...
          <Grid container justifyContent="center" spacing={1} alignItems="stretch" sx={{ minHeight: "800px" }}>
            <Grid item md={12} zeroMinWidth>
              <iframe title="Survey Results" width="100%" height="100%"
        ...
        <Dialog open={open} onClose={handleClose}>
          <DialogTitle>GHSC ICL Annual Survey</DialogTitle>
          <DialogContent>
            <iframe width="640px" height="480px" title="GHSC ICL Annual Survey" src="https://forms.office.com/r/a902w01SsC?embed=true" frameBorder="0"
