    ...
    <React.Fragment>
      <Grid container p={isLgUp ? 12 : 5}>
        ...
        <Dialog open={open} onClose={handleClose}>
          <DialogTitle>GHSC ICL Small Business Utilization</DialogTitle>
          <DialogContent>
            <iframe width="640px" height="480px" title="GHSC ICL Small Business Utilization" src="https://forms.office.com/r/A0vkHmbMee?embed=true" frameBorder="0"
