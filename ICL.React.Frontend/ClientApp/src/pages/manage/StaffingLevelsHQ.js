    ...
    <React.Fragment>
      <Grid container p={isLgUp ? 12 : 5}>
        ...
        <Dialog open={open} onClose={handleClose}>
          <DialogTitle>GHSC ICL Staffing Levels HQ and Regional</DialogTitle>
          <DialogContent>
            <iframe width="640px" height="480px" title="GHSC ICL Staffing Levels HQ and Regional" src="https://forms.office.com/r/AQxSV3VMrw?embed=true" frameBorder="0"
